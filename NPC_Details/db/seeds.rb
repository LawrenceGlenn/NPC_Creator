...
Race.create(name: "Elf", modNum: 2, modDie:7, weightMod: 3, maleBaseWeight: 100, 
  ...
  hairColor: { 
    ...
    stawberry_blond: {chance: 30, hue: {min: 35, max: 52}, saturation: {min: 75, max: 100}, lightness: {min: 55, max: 65}}, 
...
Race.create(name: "Gnome", modNum: 2, modDie:4, weightMod: 1, maleBaseWeight: 35, 
  ...
  hairColor: {
    ...
    stawberry_blond: {chance: 1, hue: {min: 35, max: 52}, saturation: {min: 75, max: 100}, lightness: {min: 55, max: 65}}, 
...
Race.create(name: "Half-Elf", modNum: 2, modDie:8, weightMod: 5, maleBaseWeight: 110, 
  ...
  hairColor: {
    ...
    stawberry_blond: {chance: 15, hue: {min: 35, max: 52}, saturation: {min: 75, max: 100}, lightness: {min: 55, max: 65}}, 
...
Race.create(name: "Half-Orc", modNum: 2, modDie:12, weightMod: 7, maleBaseWeight: 150, 
  ...
  hairColor: {
    ...
    stawberry_blond: {chance: 3, hue: {min: 35, max: 52}, saturation: {min: 75, max: 100}, lightness: {min: 55, max: 65}}, 
